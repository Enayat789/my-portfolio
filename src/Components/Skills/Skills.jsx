...
const Skills = () => {
  return (
    <div
      id="skills"
      className="w-full h-[50vh] flex flex-col justify-between gap-8 py-12 px-6  text-white "
    >
      <div className="w-full h-[50%] flex max-w-6xl sm:pl-6 lg:pl-12 xl:pl-0 mx-auto justify-center items-center relative">
        ...
        />
        <div className=" px-0.5 bg-gradient-to-r from-pink-500 to-blue-700 z-10">
          <button className="bg-gradient-to-r rounded-none from-gray-950 to-gray-900 z-10 ">
            My Skillls
          </button>
        </div>
      </div>
      ...
      <div className="w-full max-w-6xl m-auto h-full group overflow-hidden">
        <div className="flex h-full w-max justify-center animate-scroll group-hover:[animation-play-state:paused] items-center whitespace-nowrap p-4 gap-8">
          {mySkills.concat(mySkills).map((skill, index) => (
            <div
              key={index}
              className="inline-flex h-auto flex-col items-center p-4 mx-4 justify-center gap-2 hover:scale-105 transform transition-transform ease-in-out group"
            ...
            >
              ...
              <div className="w-auto h-auto p-4 sm:w-24 sm:h-24 lg:w-32 lg:h-32 flex items-center justify-center cursor-pointer bg-gradient-to-r from-gray-950 to-gray-900 border-gray-800 border-y-4 border-spacing-2 rounded-2xl hover:border-blue-800 group">
                <img
                  src={skill.icon}
                  className=" w-16 h-w-16 object-contain rounded-xl"
                />
              </div>
