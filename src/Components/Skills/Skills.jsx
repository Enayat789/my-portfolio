  ...
  return (
    <div className="w-full h-[50vh] flex flex-col justify-between gap-8 py-12 px-6  text-white ">
      ...
      <div className="w-full max-w-6xl m-auto h-auto group overflow-hidden">
        <div className="flex w-max justify-center animate-scroll group-hover:[animation-play-state:paused] items-center whitespace-nowrap gap-8">
          {mySkills.concat(mySkills).map((skill, index) => (
            <div
              key={index}
              className="inline-flex flex-col items-center p-4 mx-4 justify-center gap-2"
            ...
            >
              ...
              <div className="w-20 h-20 p-3 sm:w-24 sm:h-24 flex items-center justify-center cursor-pointer bg-gradient-to-r from-gray-950 to-gray-900 border-indigo-800 border border-spacing-2 rounded-2xl">
                <img src={skill.icon} className=" w-12 h-w-12 object-contain" />
              </div>
