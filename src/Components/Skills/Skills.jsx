...
const Skills = () => {
  return (
    <div className="w-full flex flex-col gap-8 py-12 px-6 bg-black text-white">
      <div className="w-full max-w-6xl sm:pl-6 lg:pl-12 xl:pl-0 mx-auto">
        <h2 className="text-3xl sm:text-4xl font-bold text-white uppercase tracking-wide relative">
          My Skills
          <span className="block w-16 h-1 bg-gradient-to-r from-blue-400 to-indigo-600 rounded-full mt-1"></span>
        </h2>
      </div>

      <div className="w-full max-w-6xl flex flex-wrap items-center justify-center md:justify-evenly sm:pl-6 lg:pl-12 xl:pl-0 mx-auto">
